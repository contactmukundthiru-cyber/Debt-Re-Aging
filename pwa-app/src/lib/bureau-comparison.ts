...
const COMPARISON_FIELDS: Array<{
  ...
  { key: 'currentValue', label: 'Current Balance', type: 'amount', importance: 'critical' },
...
function getLegalImplication(
  ...
  const implications: Record<string, string> = {
    ...
    currentValue: 'Balance discrepancy indicates potential FCRA §607 accuracy violation.',
...
function getSuggestedAction(
  ...
  const actions: Record<string, string> = {
    ...
    currentValue: 'Dispute value discrepancy. Request itemized statement.',
