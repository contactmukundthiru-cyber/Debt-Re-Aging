...
export const ANALYSIS_TABS = [
  ...
  { id: 'metro2', label: 'Metro 2® Audit' },
  { id: 'statutes', label: 'Statute / SOL' },
  { id: 'legalshield', label: 'Legal Shield' },
  { id: 'multibureau', label: 'Bureau Comparison' },
  { id: 'narrative', label: 'Dispute Narrative' },
  { id: 'scoresim', label: 'Score Simulator' },
  { id: 'timeline', label: 'Forensic Timeline' },
  { id: 'adversarial', label: 'Adversarial Maze' },
  { id: 'evidence', label: 'Evidence Tracker' },
  { id: 'workflow', label: 'Dispute Workflow' },
  { id: 'voice', label: 'Call Log/Voice' },
  { id: 'caselaw', label: 'Legal Precedents' },
  { id: 'deltas', label: 'Forensic Diff' },
  { id: 'discovery', label: 'Legal Discovery' },
  { id: 'lab', label: 'Forensic Lab' },
  { id: 'lettereditor', label: 'Letter Editor' },
  { id: 'actions', label: 'Master Action Plan' },
] as const;
